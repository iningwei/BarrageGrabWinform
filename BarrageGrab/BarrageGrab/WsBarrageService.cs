...
namespace BarrageGrab
{
    ...
    internal class WsBarrageService
    {
        ...
        public Action<string> onWsStartListen;

        public Action<Color, string> onTextBoxPrintDanMuData;
        ...
        private void Grab_OnGiftMessage(object sender, ProtoEntity.GiftMessage e)
        {
            ...
            if (onTextBoxPrintDanMuData != null)
            {
                onTextBoxPrintDanMuData(Color.Red, $"{enty.Content}"+",groupId:"+ enty.GroupId+", repeatEnd:"+e.repeatEnd);
            }
        ...
        private void Grab_OnLikeMessage(object sender, ProtoEntity.LikeMessage e)
        {
            ...
            //////if (onTextBoxPrintDanMuData != null)
            //////{
            //////    onTextBoxPrintDanMuData(Color.Cyan, $"{enty.Content}");
            //////}
        ...
        private void Grab_OnChatMessage(object sender, ProtoEntity.ChatMessage e)
        {
            ...
            if (onTextBoxPrintDanMuData != null)
            {
                onTextBoxPrintDanMuData(Color.Green, $"{enty.User.Nickname}: {enty.Content}");
            }
        ...
        public void StartListen()
        {
            ...
            if (onWsStartListen != null)
            {
                onWsStartListen(this.socketServer.Location);
            }
        }
